...
/*   Updated: 2024/10/04 18:43:19 by opanikov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->sprites[0] = mlx_xpm_file_to_image(data->mlx_ptr, data->hand1, &data->sprite_width, &data->sprite_height);
	data->sprites[1] = mlx_xpm_file_to_image(data->mlx_ptr, data->hand2, &data->sprite_width, &data->sprite_height);
